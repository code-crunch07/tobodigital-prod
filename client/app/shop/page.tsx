    ...
    <div className="group relative bg-white rounded-2xl overflow-hidden transition-all duration-300 hover:shadow-[0_8px_30px_rgba(0,0,0,0.08)] h-full flex flex-col border border-gray-100">
      ...
      <div className="relative aspect-square overflow-hidden bg-gray-50">
        ...
        <button
          ...
          className={`absolute top-3 right-3 z-20 w-9 h-9 rounded-full flex items-center justify-center transition-all duration-200 ${
            isWishlisted
              ? 'bg-rose-50 text-rose-500 shadow-sm'
              : 'bg-white/80 backdrop-blur-sm text-gray-400 hover:text-rose-500 hover:bg-white shadow-sm'
          }`}
        ...
        {/* Quick actions - slide up from bottom of image on hover */}
        <div className="absolute bottom-0 left-0 right-0 flex items-center justify-center gap-2 p-3 translate-y-full opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300 z-20 bg-gradient-to-t from-black/20 to-transparent">
          <button
            ...
            className="w-10 h-10 rounded-full bg-white shadow-md flex items-center justify-center text-gray-700 hover:text-gray-900 hover:scale-110 transition-all duration-200"
            title="Quick View"
          >
      ...
      <div className="p-4 flex-1 flex flex-col">
        ...
        <button
          ...
          disabled={!inStock}
          className={`mt-3 w-full rounded-xl text-sm font-semibold py-2.5 transition-all duration-200 disabled:opacity-50 ${
            isAdded
