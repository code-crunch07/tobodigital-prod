  ...
  return (
    <div className="group relative bg-white border border-gray-200 shadow-sm overflow-hidden transition-all duration-300 hover:shadow-md h-full flex flex-col">
      <div className="relative aspect-[4/3] overflow-hidden bg-gray-100 flex items-center justify-center">
        ...
        <span className="absolute top-2 left-2 z-20 inline-flex bg-green-500 text-white text-xs font-semibold px-2.5 py-1 shadow-md rounded-r-md rounded-bl-md">
          NEW
        </span>
        {discount > 0 ? (
          <div className="absolute top-2 left-2 z-20" style={{ top: '2.25rem' }}>
        ...
        {product.isFeatured ? (
          <div className="absolute left-2 z-20" style={{ top: discount > 0 ? '3.25rem' : '0.5rem' }}>
