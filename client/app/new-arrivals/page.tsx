  ...
  return (
    <div className="group relative bg-white border border-gray-200 shadow-sm overflow-hidden transition-all duration-300 hover:shadow-md h-full flex flex-col">
      <div className="relative aspect-[4/3] overflow-hidden bg-gray-50">
        ...
        <span className="absolute top-3 left-3 z-20 inline-flex bg-green-500 text-white text-xs font-semibold px-2.5 py-1 shadow-md">
          NEW
        </span>
        {discount > 0 ? (
          <div className="absolute top-3 left-3 z-20" style={{ top: '2.5rem' }}>
            <span
        ...
        {product.isFeatured ? (
          <div className="absolute left-3 z-20" style={{ top: discount > 0 ? '3.5rem' : '2.5rem' }}>
            <span
